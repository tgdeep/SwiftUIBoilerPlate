...
struct PersonListView: View {
    ...
    private var listOfAlgo : [String] = ["Palindrome", "Bubble Sort", "Insertion Sort", "Merge Sort", "Quick Sort", "Heap Sort", "Sample Legacy","Practice View", "Practice View 2", "String Algo"]
